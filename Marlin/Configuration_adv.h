...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  30, 30 }, { 300,  30 }, { 300, 300 }, { 30, 300 } }
 ...
 */
  ...
  //#define PROBE_PT_1_Y 300
  //#define PROBE_PT_2_X 30
  //#define PROBE_PT_2_Y 300
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE    420 // (mm/s) Unload filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        60  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE 420  // (mm/s) Load filament feedrate. This can be pretty fast.
